...
<template>
  <div
    class="bg-gray-900 w-full min-h-12 flex items-center px-6 justify-between"
  >
    <span
      class="absolute top-2 left-2 md:static text-red-600 text-3xl font-bold italic"
      >Movies</span
    >
    <div
    ...
    >
      <div
        class="relative flex items-end gap-1 mt-4 md:m-0 text-gray-200 cursor-pointer z-50"
